...
public class MemeController {
  ...
  public ResponseEntity<Meme> getMemeGivenId(@PathVariable String id){
    ...
    if(getMemeGivenIdResponse.getMeme()==null){
      ...
      return ResponseEntity.ok().body(getMemeGivenIdResponse.getMeme());
    }
  }
  ...
  public ResponseEntity<PostMemeResponse> addMeme( @RequestBody @Valid PostMemeRequest postMemeRequest){
    if(postMemeRequest.getCaption()==null && (postMemeRequest.getName()==null && postMemeRequest.getUrl()==null)){
      throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Data can not be empty!");
    }
